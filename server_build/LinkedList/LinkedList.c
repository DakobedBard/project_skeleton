...
void FreeLinkedList(LinkedList list,
  ...
  AssertionWrapper(list != NULL);
  AssertionWrapper(payload_free_function != NULL);
...
bool PushLinkedList(LinkedList list, void *payload) {
  ...
  if (list->num_elements == 0) {
    ...
    AssertionWrapper(list->head == NULL);  // debugging aid
    AssertionWrapper(list->tail == NULL);  // debugging aid
  ...
  AssertionWrapper(list->head != NULL);
  AssertionWrapper(list->tail != NULL);
...
bool PopLinkedList(LinkedList list, void **payload_ptr) {
  ...
  AssertionWrapper(payload_ptr != NULL);
  AssertionWrapper(list != NULL);
...
void SortLinkedList(LinkedList list, unsigned int ascending,
  ...
  AssertionWrapper(list != NULL);  // defensive programming
...
bool LLIteratorHasNext(LLIter iter) {
  // defensive programming
  AssertionWrapper(iter != NULL);
  AssertionWrapper(iter->list != NULL);
  AssertionWrapper(iter->node != NULL);
